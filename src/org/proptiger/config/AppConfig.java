...
@Configuration
@EnableWebMvc
@EnableJpaRepositories(basePackages = "org.proptiger.repository")
@ComponentScan(basePackages = "org.proptiger")
...
public class AppConfig extends WebMvcConfigurerAdapter {
	...
	// mapper.registerModule(new Hibernate)
	// }
	// @Override
